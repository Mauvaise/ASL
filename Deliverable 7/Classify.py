...
path = 'C:/Users/Tetris/Desktop/HCI 2016/Deliverable 7/userData/*.p'
fileTrain = 'train'
fileTest = 'test'
...
#print "Train signs = " + str(trainSignsArray) + str(len(trainSignsArray))
trainX, trainy = ReshapeData(trainSignsArray, trainSignSum)                                        
#
#print "Test signs = " + str(testSignsArray) + str(len(testSignsArray))
